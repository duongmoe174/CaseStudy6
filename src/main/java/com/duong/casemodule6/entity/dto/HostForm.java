...
public class HostForm {
    ...
    public HostForm(Long id, String username, String email, String password, String fullName, MultipartFile image, String address, String phone, Set<AppRole> roles) {
        this.id = id;
